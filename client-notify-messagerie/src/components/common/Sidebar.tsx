...
<div className="flex h-screen w-16 flex-col justify-between border-e dark:border-gray-700 bg-white dark:bg-gray-800">
  <div>
    ...
    <div className="border-t border-gray-100 dark:border-gray-700">
      <div className="px-2">
        <ul className="space-y-7 border-gray-100 pt-9 dark:border-gray-700">
          <li>
            <a
              href="#"
